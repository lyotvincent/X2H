...
/**
 * 对xml的解析进行改进，利用dom4j的sax机制，在读取每个节点时就进行处理，并将访问过的节点从内存中删去，避免消耗内存
 * 过大的问题出现
 * @author Liu Qiuru
 *
 */
